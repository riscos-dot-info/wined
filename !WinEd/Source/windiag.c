...
typedef enum {
  ...
  windiag_SCROLLEXTENDED,
  windiag_COLTITLEFORE = 38,
  windiag_COLTITLEBACK = 43,
  windiag_COLWORKFORE = 48,
  windiag_COLWORKBACK = 53,
  windiag_COLSCROLLOUTER = 58,
  windiag_COLSCROLLINNER = 63,
  windiag_COLFOCUS = 68,
  windiag_COLGCOL = 72,
  windiag_COL24BIT,
  windiag_COLDEFAULT
